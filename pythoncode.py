...
def data():
	...
	total = total_open_issues
	total_issues_opened_in_last_24 = len(issues_opened_in_last_24)
	total_issues_opened_in_1_to_7 = len(issues_opened_in_1_to_7) 
	total_issues_opened_in_more_than_7 = total-(total_issues_opened_in_last_24+total_issues_opened_in_1_to_7)
	        
	# print(time.time()-st)
	print(total)
	print(total_issues_opened_in_last_24)
	print(total_issues_opened_in_1_to_7)
	print(total_issues_opened_in_more_than_7) 
	return render_template("data.html",total_issues=total,issues_opened_in_last_24=total_issues_opened_in_last_24,issues_opened_in_1_to_7=total_issues_opened_in_1_to_7,issues_opened_in_more_than_7=total_issues_opened_in_more_than_7)
